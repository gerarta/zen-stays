    ...
    public function run()
    {
        DB::table('pictures')->insert([
            [
                'kost_id' => 1,
                'name' => 'Room',
                'link' => 'https://images.unsplash.com/photo-1610513492097-13a9a4c343c6?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=600&ixid=MnwxfDB8MXxyYW5kb218MHx8ZG9ybXx8fHx8fDE3MDA2NDY4ODY&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1000',
                'type' => 'Normal',
            ],
            [
                'kost_id' => 1,
