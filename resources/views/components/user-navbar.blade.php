<nav class="fixed z-50 top-0 w-screen shadow-lg backdrop-blur-sm bg-opacity-70 bg-white responsive-container py-4 px-40">
    <div class="flex justify-between items-center">
        ...
        <form class="text-[16px] flex border-2 rounded-full place-items-center">
            <i class="fa-solid fa-magnifying-glass ms-4 me-3"></i>
            <input class="border-transparent rounded-full w-80" type="text" class="rounded-full" placeholder="Enter Kost Name/Location">
