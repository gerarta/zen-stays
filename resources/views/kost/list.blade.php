                ...
                <form action="{{ route('kost.show-list') }}">
                    ...
                    <select id="price" name="price_range"
                        ...
                        <option value="500000,1000000"
                            {{ request('price_range') == '500000,1000000' ? 'selected' : '' }}>500.000 - 1.000.000
                        </option>
                        <option value="1000000,1500000"
                            {{ request('price_range') == '1000000,1500000' ? 'selected' : '' }}>1.000.000 - 1.500.000
                        </option>
                        <option value="1500000,2000000"
                            {{ request('price_range') == '1500000,2000000' ? 'selected' : '' }}>1.500.000 - 2.000.000
                        </option>
                        <option value="2000000,2500000"
                            {{ request('price_range') == '2000000,2500000' ? 'selected' : '' }}>2.000.000 - 2.500.000
                        </option>
